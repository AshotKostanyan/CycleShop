            ...
            <div class="cycle_section_2 layout_padding">
                <div class="row">
                    @foreach ($cycles as $cycle)
                        @if ($cycle->category->size == '01')
                            <div class="col-md-6">
                                <div class="box_main">
                                    <h6 class="number_text">01</h6>
                                    <div class="image_2"><img  src="images/{{ $cycle->image }}"></div>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <h1 class="cycles_text">{{ $cycle->name }}</h1>
                                <p class="lorem_text">{{ $cycle->desc }}</p>
                                <div class="btn_main">
                                    <div class="buy_bt"><a href="#">Buy Now</a></div>
                                    <h4 class="price_text">Price <span
                                            style=" color: #325662; height:480px"> {{ $cycle->price }}</span></h4>
                                </div>
                            </div>
                        @break
                    @endif
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="btn_main">
                                ...
                                <h4 class="price_text">Price </span> <span
                                        style=" color: #325662">{{$cycle->price}}</span></h4>
                            </div>
                        </div>
                        <div class="col-md-6">
